...
$statQ = $conn->prepare("
    SELECT
        AVG(brix_ari)      AS avg_brix,
        MIN(brix_ari)      AS min_brix,
        MAX(brix_ari)      AS max_brix,

        AVG(pol_ari)       AS avg_pol,
        MIN(pol_ari)       AS min_pol,
        MAX(pol_ari)       AS max_pol,

        AVG(rendemen_ari)  AS avg_rendemen,
        MIN(rendemen_ari)  AS min_rendemen,
        MAX(rendemen_ari)  AS max_rendemen
    FROM analisa_on_farms
    WHERE ari_at BETWEEN ? AND ?
");
...
<div class="container content-container">
    ...
    <div class="card">
        <div class="card-header text-left">
            <strong>Analisa Rendemen Individu</strong>
        </div>
